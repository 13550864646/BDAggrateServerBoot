...
public class MinaConfig {
    ...
    private No8OneWayParser no80neWayParser;
    @Resource(name = "no8TwoWayParser")
    private NoSTwoWayParser no8TwoWayParser;
    ...
    public UnitASportComponent getUnitASportComponent() {
        ...
        unitASportComponent.add(noBOneWayParser);
        unitASportComponent.add(noBTwoWayParser);
        unitASportComponent.add(noBThreeWayParser);
